...
{{-- Page title --}}
@section('title'){{ $title = trans('cpvm-block::language.titles.block.create') }}@stop
    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <!-- errors -->
                <form action="{{ route('cpvm.block.block.add') }}" method="post" id="form-add-block">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                    <div class="row">
                        <div class="col-sm-3">
                            <label>{{ trans('cpvm-block::language.label.block.name') }}</label>
                            <div class="form-group">
                                <input type="text" name="name" class="form-control" placeholder="{{ trans('cpvm-block::language.placeholder.block.name') }}">
                            </div>
                        </div>
                        <div class="col-sm-3">
