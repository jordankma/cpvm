...
{{-- Page title --}}
@section('title'){{ $title = trans('cpvm-block::language.titles.block.manage') }}@stop
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        @if ($USER_LOGGED->canAccess('cpvm.block.block.create'))
                        <a href="{{ route('cpvm.block.block.create') }}" class="btn btn-sm btn-default">
                            <span class="glyphicon glyphicon-plus"></span> 
                            {{ trans('cpvm-block::language.buttons.create') }}
                        </a>
                        @endif
                    </div>
                </div>
