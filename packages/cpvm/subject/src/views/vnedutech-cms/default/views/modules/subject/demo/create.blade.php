...
{{-- Page title --}}
@section('title'){{ $title = trans('cpvm-subject::language.titles.demo.create') }}@stop
    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <!-- errors -->
                {!! Form::open(array('url' => route('cpvm.subject.demo.add'), 'method' => 'post', 'class' => 'bf', 'id' => 'demoForm', 'files'=> true)) !!}
