...
{{-- Page title --}}
@section('title'){{ $title = trans('cpvm-level::language.titles.level.update') }}@stop
    ...
    <section class="content paddingleft_right15">
        ...
        <div class="row">
            <div class="the-box no-border">
                <!-- errors -->
                <form action="{{route('cpvm.level.level.update')}}" method="post" class="bf" id="form-add-level">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <input type="text" name="name" class="form-control" placeholder="{{trans('cpvm-level::language.placeholder.level.name')}}" autofocus="" value="{{$level->name}}">
                            </div>
                            <label>{{trans('cpvm-level::language.label.level.color')}}<span style="color: red">(*)</span></label>
                            <div class="form-group">
                                <input id="mycp1" type="text" name="color" class="form-control colorpicker-element" placeholder="{{trans('cpvm-level::language.placeholder.level.color')}}" value="{{$level->color}}">
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                   ...
                                   <input type="text" name="background" id="thumbnail1" class="form-control" value="{{$level->background}}">
                                 </div>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="radio" id="mamnon" name="type" value="1" @if($level->type==1) checked="checked"@endif>
                                <label for="mamnon">{{trans('cpvm-level::language.label.level.mamnon')}}</label>
                                <input type="radio" id="khac" name="type" value="2" @if($level->type==2) checked="checked"@endif>
                            ...
                            <div class="form-group">
                                <input id="mycp2" type="text" name="color_mobile" class="form-control" placeholder="{{trans('cpvm-level::language.placeholder.level.color_mobile')}}" value="{{$level->color_mobile}}">
                            </div>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                   ...
                                   <input type="text" name="background_mobile" id="thumbnail2" class="form-control" value="{{$level->background_mobile}}">
                                 </div>
